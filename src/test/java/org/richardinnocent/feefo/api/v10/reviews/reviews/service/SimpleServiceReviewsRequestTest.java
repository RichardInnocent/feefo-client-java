...
class SimpleServiceReviewsRequestTest {

  @Test
  public void getBasePath_Always_AsExpected() {
    assertEquals(
        "/10/reviews/service",
        SimpleServiceReviewsRequest.builder().forMerchant("test-merchant").build().getBasePath()
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierIsNull_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleServiceReviewsRequest.builder().forMerchant(null)
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierSet_OnlyParameterSet() {
    String merchantIdentifier = "test-merchant";
    SimpleServiceReviewsRequest request =
        SimpleServiceReviewsRequest.builder().forMerchant(merchantIdentifier).build();
  ...
  public void builder$withSortField_NotNull_SetsParameter() {
    ...
    SimpleServiceReviewsRequest request = SimpleServiceReviewsRequest
        .builder()
  ...
  public void builder$withPage_PageIsZero_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleServiceReviewsRequest.builder().forMerchant("test-merchant").withPage(0)
    );
  }
  ...
  public void builder$withPage_PageIsNegative_ExceptionThrown() {
    assertThrows(
        IllegalArgumentException.class,
        () -> SimpleServiceReviewsRequest.builder().forMerchant("test-merchant").withPage(-1)
    );
  }
