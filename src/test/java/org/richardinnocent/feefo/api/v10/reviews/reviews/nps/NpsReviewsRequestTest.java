package org.richardinnocent.feefo.api.v10.reviews.reviews.nps;
...
import org.richardinnocent.feefo.api.v10.reviews.reviews.nps.params.SortField;
...
class NpsReviewsRequestTest {

  @Test
  public void getBasePath_Always_AsExpected() {
    assertEquals(
        "/10/reviews/nps",
        NpsReviewsRequest.builder().forMerchant("test-merchant").build().getBasePath()
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierIsNull_ExceptionThrown() {
    assertThrows(
        ...
        () -> NpsReviewsRequest.builder().forMerchant(null)
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierSet_OnlyParameterSet() {
    String merchantIdentifier = "test-merchant";
    NpsReviewsRequest request =
        NpsReviewsRequest.builder().forMerchant(merchantIdentifier).build();
  ...
  public void builder$withSortField_NotNull_SetsParameter() {
    SortField sortField = SortField.FEEDBACK_CREATION_TIME;
    NpsReviewsRequest request = NpsReviewsRequest
        .builder()
  ...
  public void builder$withPage_PageIsZero_ExceptionThrown() {
    assertThrows(
        ...
        () -> NpsReviewsRequest.builder().forMerchant("test-merchant").withPage(0)
    );
  }
  ...
  public void builder$withPage_PageIsNegative_ExceptionThrown() {
    assertThrows(
        IllegalArgumentException.class,
        () -> NpsReviewsRequest.builder().forMerchant("test-merchant").withPage(-1)
    );
  }
