...
class EnrichedAllReviewsRequestTest {
  ...
  public void getBasePath_Always_AsExpected() {
    assertEquals(
        "/10/reviews/all",
        EnrichedAllReviewsRequest.builder().forMerchant("test-merchant").build().getBasePath()
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierIsNull_ExceptionThrown() {
    assertThrows(
        ...
        () -> EnrichedAllReviewsRequest.builder().forMerchant(null)
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierSet_OnlyParameterSet() {
    String merchantIdentifier = "test-merchant";
    EnrichedAllReviewsRequest request =
        EnrichedAllReviewsRequest.builder().forMerchant(merchantIdentifier).build();
