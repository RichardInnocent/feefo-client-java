...
class SimpleAllReviewsRequestTest {
  ...
  public void getBasePath_Always_AsExpected() {
    assertEquals(
        "/10/reviews/all",
        SimpleAllReviewsRequest.builder().forMerchant("test-merchant").build().getBasePath()
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierIsNull_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleAllReviewsRequest.builder().forMerchant(null)
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierSet_OnlyParameterSet() {
    String merchantIdentifier = "test-merchant";
    SimpleAllReviewsRequest request =
        SimpleAllReviewsRequest.builder().forMerchant(merchantIdentifier).build();
  ...
  public void builder$withSortField_NotNull_SetsParameter() {
    ...
    SimpleAllReviewsRequest request = SimpleAllReviewsRequest
        .builder()
        .forMerchant("test-merchant")
  ...
  public void builder$withPage_PageIsZero_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleAllReviewsRequest.builder().forMerchant("test-merchant").withPage(0)
    );
  }
  ...
  public void builder$withPage_PageIsNegative_ExceptionThrown() {
    assertThrows(
        IllegalArgumentException.class,
        () -> SimpleAllReviewsRequest.builder().forMerchant("test-merchant").withPage(-1)
    );
  }
