...
class SimpleProductReviewsRequestTest {

  @Test
  public void getBasePath_Always_AsExpected() {
    assertEquals(
        "/10/reviews/product",
        SimpleProductReviewsRequest
            .builder()
  ...
  public void builder$forMerchant_MerchantIdentifierIsNull_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleProductReviewsRequest.builder().forMerchant(null)
    );
  }
  ...
  public void builder$forMerchant_MerchantIdentifierIsEmpty_ExceptionThrown() {
    assertThrows(
        ...
        () -> SimpleProductReviewsRequest.builder().forMerchant("")
    );
  }
  ...
  public void builder$withSortField_NotNull_SetsParameter() {
    ...
    SimpleProductReviewsRequest request = SimpleProductReviewsRequest
        .builder()
        .forMerchant("test-merchant")
        .withProductSku("test-product-sku")
